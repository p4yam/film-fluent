...
Future<void> init() async {
  ...
  getIt.registerLazySingleton<MovieDetailRemoteDataSource>(() =>
      MovieDetailRemoteDataSourceImpl(
          ...
          baseUrl: AppKeys.AppApiUrl));
  getIt.registerLazySingleton<MovieDetailLocalDataSource>(() => MovieDetailLocalDataSourceImpl());
  getIt.registerFactory<MovieDetailRepository>(
      () => MovieDetailRepositoryImpl(remoteDataSource: getIt(),localDataSource: getIt()));
}
